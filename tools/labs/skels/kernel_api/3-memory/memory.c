...
static int memory_init(void)
{
	...
	//struct task_info *next = next_task(current);
...
static void memory_exit(void)
{
	...
	printk("Ti1 has pid: %d and timestamp %lu\n", ti1->pid, ti1->timestamp);
	printk("Ti2 has pid: %d and timestamp %lu\n", ti2->pid, ti2->timestamp);
	printk("Ti3 has pid: %d and timestamp %lu\n", ti3->pid, ti3->timestamp);
	printk("Ti4 has pid: %d and timestamp %lu\n", ti4->pid, ti4->timestamp);
